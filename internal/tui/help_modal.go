...
func (m *Model) BuildHelpContent() string {
	...
	b.WriteString(keyStyle.Render("→") + descStyle.Render("Next page") + "\n")
	...
	b.WriteString(keyStyle.Render("d") + descStyle.Render("Describe selected resource") + "\n")
	b.WriteString(keyStyle.Render("y") + descStyle.Render("View resource YAML manifest") + "\n")
	b.WriteString(keyStyle.Render("e") + descStyle.Render("Edit resource in $EDITOR") + "\n")
	b.WriteString(keyStyle.Render("l") + descStyle.Render("View logs (pods view) / next page") + "\n")
	...
	b.WriteString(cmdStyle.Render(":ns") + descStyle.Render("List available namespaces") + "\n")
	b.WriteString(cmdStyle.Render(":ns <name>") + descStyle.Render("Switch to namespace") + "\n")
	b.WriteString(cmdStyle.Render(":ns all") + descStyle.Render("Show all namespaces") + "\n")
